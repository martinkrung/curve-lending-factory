...
NAME: public(constant(string[64])) = "semilog"
...
@external
def __init__(borrowed_token: ERC20, rates: uint256[2]):  # Accept an array of two uint256 values
    min_rate: uint256 = rates[0]  # Set min_rate from the array
    max_rate: uint256 = rates[1]  # Set max_rate from the array
